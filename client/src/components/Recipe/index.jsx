...
// קוד שעובד וחוץ מהקישור לצד שרת אין שום הבדל בין הראשון לזה המידע חוזר כדרוש
function Recipe() {
    ...
    return (
        ...
        <button className={style.likeButton} onClick={hendalLikes}>
            ❤️
        </button>
        <h1>{recipe && recipe.name}</h1>
        ...
        <img className={style.recipeImage} src={recipe && recipe.image} alt={recipe && recipe.name} />
